...
namespace M3H5Lib.Api
{
	...
	/// <summary>
	/// Name: OSS420MI
	/// Component Name: SalesBudget
	/// Description: Sales budget interface
	/// Version Release: 12.1
	///</summary>
	public partial class OSS420MIResource : M3BaseResourceEndpoint
	{
		public OSS420MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "OSS420MI";
