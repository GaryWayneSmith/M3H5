...
{
	public partial class LstItmByChgDateResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Description - Procurment group
		/// FieldName: DS07
		/// FieldType: A
		/// Length: 15
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Description - Purchase order U/M")]
		public string M3DS08 => GetString("DS08");
		...
		[JsonIgnore]
		[Description("Description - Tax code customer/address")]
		public string M3DS09 => GetString("DS09");
		...
		/// <summary>
		/// Description: Induvidual item tracing
		/// FieldName: ITRC
		/// FieldType: N
		/// Length: 1
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Description - VAT code purchase")]
		public string M3DS10 => GetString("DS10");
		...
		[JsonIgnore]
		[Description("Description - VAT code - sales")]
		public string M3DS11 => GetString("DS11");
