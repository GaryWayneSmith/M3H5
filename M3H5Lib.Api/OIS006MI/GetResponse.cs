...
namespace M3H5Lib.Api.OIS006MI
{
	public partial class GetResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Strict rotation date
		/// FieldName: SRDT
		/// FieldType: D
		/// Length: 10
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Strict rotation date")]
		public DateTime? M3_SRDT => GetNullableDateTime("SRDT");
		...
		[JsonIgnore]
		[Description("Last delivery date")]
		public DateTime? M3_LDED => GetNullableDateTime("LDED");
