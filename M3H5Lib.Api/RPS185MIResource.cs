...
namespace M3H5Lib.Api
{
	...
	public partial class RPS185MIResource : M3BaseResourceEndpoint
	{
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/AddPLTRule",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/ChangePLTRule",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/CopyPLTRule",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/DeletePLTRule",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/ListPLTRule",
			};
