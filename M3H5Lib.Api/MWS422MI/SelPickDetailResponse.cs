...
namespace M3H5Lib.Api.MWS422MI
{
	public partial class SelPickDetailResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("To location pick line")]
		public string M3TWS2 => GetString("TWS2");
		...
		[JsonIgnore]
		[Description("Allocated quantity - nominal")]
		public decimal? M3ALQN => GetNullableDecimal("ALQN");
		...
		[JsonIgnore]
		[Description("Generic Item")]
		public string M3GENE => GetString("GENE");
		...
		[JsonIgnore]
		[Description("Logistics U/M On")]
		public int? M3LGON => GetNullableInt("LGON");
		...
		[JsonIgnore]
		[Description("Cartonization U/M")]
		public string M3AUCZ => GetString("AUCZ");
		...
		[JsonIgnore]
		[Description("Original reporting number - picking line")]
		public decimal? M3ORRN => GetNullableDecimal("ORRN");
