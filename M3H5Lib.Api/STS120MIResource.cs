...
namespace M3H5Lib.Api
{
	...
	public partial class STS120MIResource : M3BaseResourceEndpoint
	{
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/AddPrcLstLines",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/DelPrcLstLines",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/GetPrcLstLines",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/GetPrcLstLines2",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/LstPrclistLines",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(Config)
			{
				EndpointUri = $"{Config.BasePath}/{ProgramName}/UpdPrclistlines",
			};
