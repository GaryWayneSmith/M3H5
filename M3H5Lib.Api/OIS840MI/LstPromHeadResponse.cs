...
namespace M3H5Lib.Api.OIS840MI
{
	public partial class LstPromHeadResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Initial start")]
		public DateTime? M3INIS => GetNullableDateTime("INIS");
		...
		[JsonIgnore]
		[Description("Initial end")]
		public DateTime? M3INIE => GetNullableDateTime("INIE");
		...
		[JsonIgnore]
		[Description("Auto retrieval of promotion")]
		public DateTime? M3ANIN => GetNullableDateTime("ANIN");
		...
		[JsonIgnore]
		[Description("Hold Initial order")]
		public int? M3HOIN => GetNullableInt("HOIN");
		...
		[JsonIgnore]
		[Description("Consumed percent")]
		public int? M3COPT => GetNullableInt("COPT");
	}
}
// EOF
