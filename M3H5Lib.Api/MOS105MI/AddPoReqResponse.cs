...
namespace M3H5Lib.Api.MOS105MI
{
	public partial class AddPoReqResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Reference order operation
		/// FieldName: RORO
		/// FieldType: N
		/// Length: 6
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Reference order operation")]
		public int? M3_RORO => GetNullableInt("RORO");
	}
}
// EOF
