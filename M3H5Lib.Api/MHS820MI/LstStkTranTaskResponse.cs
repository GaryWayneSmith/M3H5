...
namespace M3H5Lib.Api.MHS820MI
{
	public partial class LstStkTranTaskResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Stock Transaction Typr
		/// FieldName: TTYP
		/// FieldType: N
		/// Length: 2
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("New unit of measure")]
		public string M3_NUNM => GetString("NUNM");
