...
namespace M3H5Lib.Api.MHS635MI
{
	public partial class LstAliasExtractResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Primary Alias number
		/// FieldName: PPOP
		/// FieldType: A
		/// Length: 30
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Primary Alias number")]
		public string M3_PPOP => GetString("PPOP");
		...
		[JsonIgnore]
		[Description("Alias type")]
		public string M3_ATPE => GetString("ATPE");
