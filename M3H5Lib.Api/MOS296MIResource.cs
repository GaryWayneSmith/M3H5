...
namespace M3H5Lib.Api
{
	...
	/// <summary>
	/// Name: MOS296MI
	/// Component Name: Operational Enviroment
	/// Description: Api: Operational Enviroment
	/// Version Release: 14.x
	///</summary>
	public partial class MOS296MIResource : M3BaseResourceEndpoint
	{
		public MOS296MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "MOS296MI";
