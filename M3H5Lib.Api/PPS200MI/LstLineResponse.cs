...
namespace M3H5Lib.Api.PPS200MI
{
	public partial class LstLineResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Price quantity base U/M
		/// FieldName: PUQT
		/// FieldType: N
		/// Length: 17
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Received qty - basic U/M
		/// FieldName: RVQT
		/// FieldType: N
		/// Length: 17
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Confirmed qty - basic U/M
		/// FieldName: CFQT
		/// FieldType: N
		/// Length: 17
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Confirmed qty - basic U/M")]
		public decimal? M3CFQT => GetNullableDecimal("CFQT");

		/// <summary>
		/// Description: Confirmed purchase price in local currency
		/// FieldName: CUCP
		/// FieldType: N
		/// Length: 19
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Confirmed purchase price in local currency")]
		public decimal? M3CUCP => GetNullableDecimal("CUCP");
		...
		[JsonIgnore]
		[Description("Ordering facility")]
		public string M3OFCI => GetString("OFCI");
