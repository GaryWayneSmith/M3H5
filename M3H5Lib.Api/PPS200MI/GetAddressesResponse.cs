...
{
	public partial class GetAddressesResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Invoice Receiver name
		/// FieldName: INAM
		/// FieldType: A
		/// Length: 36
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("County ID")]
		public string M3_SFRC => GetString("SFRC");
		...
		[JsonIgnore]
		[Description("County ID")]
		public string M3_IFRC => GetString("IFRC");
