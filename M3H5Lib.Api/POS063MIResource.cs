...
namespace M3H5Lib.Api
{
	...
	/// <summary>
	/// Name: POS063MI
	/// Component Name: ActivityStartFinish
	/// Description: Start/finish activity interface
	/// Version Release: 12.4
	///</summary>
	public partial class POS063MIResource : M3BaseResourceEndpoint
	{
		public POS063MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "POS063MI";
			payloadFactory = new PayloadFactory();
		}

		/// <summary>
		/// Name SetStatus
		/// Description Set status on project activity
		/// Version Release: 12.4
		/// </summary>
