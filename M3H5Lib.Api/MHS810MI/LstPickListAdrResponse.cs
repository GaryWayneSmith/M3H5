...
{
	public partial class LstPickListAdrResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Facsimile transmissi
		/// FieldName: TFNO
		/// FieldType: A
		/// Length: 16
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: VAT registration num
		/// FieldName: VRNO
		/// FieldType: A
		/// Length: 16
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Tax code customer/ad
		/// FieldName: TAXC
		/// FieldType: A
		/// Length: 3
		/// Nullabe: Y
