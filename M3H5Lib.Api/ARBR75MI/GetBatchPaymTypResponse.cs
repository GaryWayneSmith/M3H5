...
{
	public partial class GetBatchPaymTypResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Batch payment type")]
		public string M3BOPE => GetString("BOPE");
		...
		[JsonIgnore]
		[Description("Submit job")]
		public string M3SBJB => GetString("SBJB");
		...
		[JsonIgnore]
		[Description("Read in")]
		public int? M3DWLD => GetNullableInt("DWLD");
		...
		[JsonIgnore]
		[Description("Allocation reference")]
		public string M3ALRF => GetString("ALRF");
