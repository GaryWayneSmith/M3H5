...
{
	public partial class AddServOrdResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Proposal status")]
		public string M3_PPST => GetString("PPST");

		/// <summary>
		/// Description: Service assignment number
		/// FieldName: JOBN
		/// FieldType: N
		/// Length: 3
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Service assignment suffix
		/// FieldName: JBSX
		/// FieldType: N
		/// Length: 2
		/// Nullabe: Y
