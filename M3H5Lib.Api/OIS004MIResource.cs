...
namespace M3H5Lib.Api
{
	...
	public partial class OIS004MIResource : M3BaseResourceEndpoint
	{
		...
		/// <param name="m3DLSP">Delivery specification (Required)</param>
		/// <param name="m3DSTX">Description (Required)</param>
			...
			CancellationToken cancellationToken = default)
		{
			...
			if (string.IsNullOrWhiteSpace(m3DLSP))
				throw new ArgumentNullException(nameof(m3DLSP));
			if (string.IsNullOrWhiteSpace(m3DSTX))
				throw new ArgumentNullException(nameof(m3DSTX));

			// Set mandatory parameters
			request
				.WithQueryParameter("CUNO", m3CUNO.Trim())
				.WithQueryParameter("DLSP", m3DLSP.Trim())
				.WithQueryParameter("DSTX", m3DSTX.Trim());
