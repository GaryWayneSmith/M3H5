...
{
	public partial class LstCostElementsResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Field")]
		public string M3_EX01 => GetString("EX01");
		...
		[JsonIgnore]
		[Description("Field")]
		public string M3_EX02 => GetString("EX02");
		...
		[JsonIgnore]
		[Description("Field")]
		public string M3_EX03 => GetString("EX03");
		...
		[JsonIgnore]
		[Description("Field")]
		public string M3_EX04 => GetString("EX04");
		...
		[JsonIgnore]
		[Description("Field")]
		public string M3_EX05 => GetString("EX05");
	}
}
// EOF
