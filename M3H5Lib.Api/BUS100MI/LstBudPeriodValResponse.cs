...
{
	public partial class LstBudPeriodValResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Budget period")]
		public int? M3_BUPE => GetNullableInt("BUPE");
		...
		[JsonIgnore]
		[Description("Foreign currency amount - budget")]
		public decimal? M3_BCUA => GetNullableDecimal("BCUA");
		...
		[JsonIgnore]
		[Description("Local currency amount - budget")]
		public decimal? M3_BLAM => GetNullableDecimal("BLAM");
		...
		[JsonIgnore]
		[Description("Budget quantity")]
		public decimal? M3_BUDQ => GetNullableDecimal("BUDQ");
