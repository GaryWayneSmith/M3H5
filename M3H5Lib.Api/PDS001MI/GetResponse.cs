...
namespace M3H5Lib.Api.PDS001MI
{
	public partial class GetResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Number of production lot cards")]
		public int? M3NUC8 => GetNullableInt("NUC8");
		...
		[JsonIgnore]
		[Description("Percentage BOM")]
		public int? M3PCBO => GetNullableInt("PCBO");
		...
		[JsonIgnore]
		[Description("Production lot controlled/op exist")]
		public int? M3PPMG => GetNullableInt("PPMG");
		...
		[JsonIgnore]
		[Description("Kit printout PO")]
		public int? M3KPPO => GetNullableInt("KPPO");
		...
		[JsonIgnore]
		[Description("Allow date gap")]
		public int? M3AGAP => GetNullableInt("AGAP");
	}
}
// EOF
