...
namespace M3H5Lib.Api
{
	...
	/// <summary>
	/// Name: MOS297MI
	/// Component Name: Industry Application
	/// Description: Api: Industry Application
	/// Version Release: 14.x
	///</summary>
	public partial class MOS297MIResource : M3BaseResourceEndpoint
	{
		public MOS297MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "MOS297MI";
