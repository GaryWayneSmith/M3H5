...
namespace M3H5Lib.Api
{
	...
	/// <summary>
	/// Name: CRS621MI
	/// Component Name: Contact Type
	/// Description: Contact Type
	/// Version Release: 14.x
	///</summary>
	public partial class CRS621MIResource : M3BaseResourceEndpoint
	{
		public CRS621MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "CRS621MI";
			PayloadFactory = new PayloadFactory();
		}

		/// <summary>
		/// Name Add
		/// Description Add Contact Type
		/// Version Release: 15
		/// </summary>
