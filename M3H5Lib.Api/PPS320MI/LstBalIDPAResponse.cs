...
{
	public partial class LstBalIDPAResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Latest approval date
		/// FieldName: LPUD
		/// FieldType: D
		/// Length: 10
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Latest approval date")]
		public DateTime? M3_LPUD => GetNullableDateTime("LPUD");
		...
		/// <summary>
		/// Description: Latest reject date
		/// FieldName: LRJD
		/// FieldType: N
		/// Length: 8
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Latest reject date")]
		public int? M3_LRJD => GetNullableInt("LRJD");
		...
		[JsonIgnore]
		[Description("Location")]
		public string M3_WHS2 => GetString("WHS2");
		...
		[JsonIgnore]
		[Description("Lot number")]
		public string M3_BAN2 => GetString("BAN2");
		...
		[JsonIgnore]
		[Description("Lot reference 1")]
		public string M3_BRF1 => GetString("BRF1");
		...
		[JsonIgnore]
		[Description("Lot reference 2")]
		public string M3_BRF2 => GetString("BRF2");
		...
		[JsonIgnore]
		[Description("Catch weight")]
		public decimal? M3_CWE2 => GetNullableDecimal("CWE2");
		...
		[JsonIgnore]
		[Description("Priority date")]
		public DateTime? M3_PRD2 => GetNullableDateTime("PRD2");
		...
		[JsonIgnore]
		[Description("Remark")]
		public string M3_BRM2 => GetString("BRM2");
		...
		/// <summary>
		/// Description: On-hand balance - Purchase order U/M
		/// FieldName: PUUQ
		/// FieldType: A
		/// Length: 11
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("On-hand balance - Purchase order U/M")]
		public string M3_PUUQ => GetString("PUUQ");
	}
}
// EOF
