...
namespace M3H5Lib.Api.PPS320MI
{
	public partial class LstBalIDPAResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Latest approval date")]
		public DateTime? M3LPUD => GetNullableDateTime("LPUD");
		...
		[JsonIgnore]
		[Description("Latest reject date")]
		public int? M3LRJD => GetNullableInt("LRJD");
		...
		[JsonIgnore]
		[Description("Location")]
		public string M3WHS2 => GetString("WHS2");
		...
		[JsonIgnore]
		[Description("Lot number")]
		public string M3BAN2 => GetString("BAN2");
		...
		[JsonIgnore]
		[Description("Lot reference 1")]
		public string M3BRF1 => GetString("BRF1");
		...
		[JsonIgnore]
		[Description("Lot reference 2")]
		public string M3BRF2 => GetString("BRF2");
		...
		[JsonIgnore]
		[Description("Catch weight")]
		public decimal? M3CWE2 => GetNullableDecimal("CWE2");
		...
		[JsonIgnore]
		[Description("Priority date")]
		public DateTime? M3PRD2 => GetNullableDateTime("PRD2");
		...
		[JsonIgnore]
		[Description("Remark")]
		public string M3BRM2 => GetString("BRM2");
		...
		[JsonIgnore]
		[Description("On-hand balance - Purchase order U/M")]
		public string M3PUUQ => GetString("PUUQ");
	}
}
// EOF
