...
namespace M3H5Lib.Api
{
	...
	public partial class QMS001MIResource : M3BaseResourceEndpoint
	{
		...
		/// Version Release: 
		/// </summary>
		/// <param name="m3_QLCD">Qualitative code</param>
			...
			CancellationToken cancellationToken = default)
		{
			...
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/AddQualitative",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/DltQualitative",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/GetQualitative",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/LstQualitative",
			};
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/UpdQualitative",
			};
