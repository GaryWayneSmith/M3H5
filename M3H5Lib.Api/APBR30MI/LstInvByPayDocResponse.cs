...
{
	public partial class LstInvByPayDocResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Bar Cd Bk Code")]
		public string M3_XBCB => GetString("XBCB");

		/// <summary>
		/// Description: Bar code for currency code
		/// FieldName: XBCC
		/// FieldType: A
		/// Length: 1
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Bar code for currency code")]
		public string M3_XBCC => GetString("XBCC");
		...
		[JsonIgnore]
		[Description("Digit")]
		public string M3_XBCD => GetString("XBCD");

		/// <summary>
		/// Description: Bar Code Due Date Factor
		/// FieldName: XBCF
		/// FieldType: A
		/// Length: 4
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Bar Code Due Date Factor")]
		public string M3_XBCF => GetString("XBCF");

		/// <summary>
		/// Description: Bar Code Amount
		/// FieldName: XBCA
		/// FieldType: N
		/// Length: 12
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Bar Code Amount")]
		public decimal? M3_XBCA => GetNullableDecimal("XBCA");

		/// <summary>
		/// Description: Bar code for free field
		/// FieldName: XBFF
		/// FieldType: A
		/// Length: 25
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Bar code for free field")]
		public string M3_XBFF => GetString("XBFF");

		/// <summary>
		/// Description: Invoice Number at Bank
		/// FieldName: XINB
		/// FieldType: A
		/// Length: 24
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Invoice Number at Bank")]
		public string M3_XINB => GetString("XINB");
		...
		[JsonIgnore]
		[Description("Accept")]
		public string M3_XACC => GetString("XACC");
		...
		[JsonIgnore]
		[Description("Portfolio")]
		public string M3_XPOR => GetString("XPOR");
