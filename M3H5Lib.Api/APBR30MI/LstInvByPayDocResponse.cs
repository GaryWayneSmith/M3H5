...
namespace M3H5Lib.Api.APBR30MI
{
	public partial class LstInvByPayDocResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Bar Cd Bk Code")]
		public string M3XBCB => GetString("XBCB");
		...
		[JsonIgnore]
		[Description("Bar code for currency code")]
		public string M3XBCC => GetString("XBCC");
		...
		[JsonIgnore]
		[Description("Digit")]
		public string M3XBCD => GetString("XBCD");
		...
		[JsonIgnore]
		[Description("Bar Code Due Date Factor")]
		public string M3XBCF => GetString("XBCF");
		...
		[JsonIgnore]
		[Description("Bar Code Amount")]
		public decimal? M3XBCA => GetNullableDecimal("XBCA");
		...
		[JsonIgnore]
		[Description("Bar code for free field")]
		public string M3XBFF => GetString("XBFF");
		...
		[JsonIgnore]
		[Description("Invoice Number at Bank")]
		public string M3XINB => GetString("XINB");
		...
		[JsonIgnore]
		[Description("Accept")]
		public string M3XACC => GetString("XACC");
		...
		[JsonIgnore]
		[Description("Portfolio")]
		public string M3XPOR => GetString("XPOR");
