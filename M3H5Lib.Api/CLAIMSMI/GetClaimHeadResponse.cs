...
namespace M3H5Lib.Api.CLAIMSMI
{
	public partial class GetClaimHeadResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Teps Claim")]
		public int? M3_TEPS => GetNullableInt("TEPS");
		...
		[JsonIgnore]
		[Description("Text")]
		public string M3_RTX1 => GetString("RTX1");
		...
		[JsonIgnore]
		[Description("Text")]
		public string M3_RTX2 => GetString("RTX2");
		...
		[JsonIgnore]
		[Description("Text")]
		public string M3_RTX3 => GetString("RTX3");
		...
		[JsonIgnore]
		[Description("Text")]
		public string M3_RTX4 => GetString("RTX4");
