...
namespace M3H5Lib.Api
{
	...
	///</summary>
	public partial class CMS008MIResource : M3BaseResourceEndpoint
	{
		public CMS008MIResource(ApiClient apiClient)
			: base(apiClient)
		{
		...
		/// <summary>
		/// Name AddFields
		/// Description Add fields to field group
		/// Version Release: 6400
		/// </summary>
		...
		/// <summary>
		/// Name AddSectionTable
		/// Description Add a section table
		/// Version Release: 6400
		/// </summary>
		/// <param name="m3PRTF">Printer file (Required)</param>
		/// <param name="m3RPBK">XML section (Required)</param>
		...
		/// <param name="m3RPBA">Base XML section (Required)</param>
		...
		/// <returns>M3Response<M3Record></returns>
		/// <exception cref="M3Exception<M3Record>"></exception>
		public async Task<M3Response<M3Record>> AddSectionTable(
			string m3PRTF, 
			int m3RPBK, 
			string m3FILE, 
			string m3FIPX, 
			...
			CancellationToken cancellationToken = default)
		{
			...
			request
				...
				.WithQueryParameter("RPBA", m3RPBA.ToString(CultureInfo.CurrentCulture));
		...
		/// <summary>
		/// Name DltSectionTable
		/// Description Delete a section table
		/// Version Release: 6400
		/// </summary>
		/// <param name="m3PRTF">Printer file (Required)</param>
		/// <param name="m3RPBK">XML section (Required)</param>
		...
		/// <returns>M3Response<M3Record></returns>
		/// <exception cref="M3Exception<M3Record>"></exception>
		public async Task<M3Response<M3Record>> DltSectionTable(
			string m3PRTF, 
			int m3RPBK, 
			string m3FILE, 
			int? maxRecords = null, 
		...
		/// <summary>
		/// Name GetSectionTable
		/// Description Get data for a section table
		/// Version Release: 6400
		/// </summary>
		/// <param name="m3PRTF">Printer file (Required)</param>
		/// <param name="m3RPBK">XML section (Required)</param>
		...
		/// <param name="outputColumns">List of columns to return, null or empty for all columns</param>
		/// <param name="cancellationToken"></param>
		/// <returns>M3Response<GetSectionTableResponse></returns>
		/// <exception cref="M3Exception<GetSectionTableResponse>"></exception>
		public async Task<M3Response<GetSectionTableResponse>> GetSectionTable(
			string m3PRTF, 
			int m3RPBK, 
			string m3FILE, 
			int? maxRecords = null, 
			...
			CancellationToken cancellationToken = default)
		{
			...
			// Execute the request
			var result = await Execute<GetSectionTableResponse>(
				request: request,
				maxRecords: maxRecords,
				includeMetadata: includeMetadata,
				trimResults: trimResults,
		...
		/// <summary>
		/// Name LstSectionTable
		/// Description List data for section table
		/// Version Release: 6400
		/// </summary>
		...
		/// <param name="outputColumns">List of columns to return, null or empty for all columns</param>
		/// <param name="cancellationToken"></param>
		/// <returns>M3Response<LstSectionTableResponse></returns>
		/// <exception cref="M3Exception<LstSectionTableResponse>"></exception>
		public async Task<M3Response<LstSectionTableResponse>> LstSectionTable(
			string m3PRTF = null, 
			int? m3RPBK = null, 
			string m3FILE = null, 
			int? maxRecords = null, 
			...
			CancellationToken cancellationToken = default)
		{
			...
			// Execute the request
			var result = await Execute<LstSectionTableResponse>(
				request: request,
				maxRecords: maxRecords,
				includeMetadata: includeMetadata,
				trimResults: trimResults,
		...
		/// <summary>
		/// Name UpdSectionTable
		/// Description Update data for a section table
		/// Version Release: 6400
		/// </summary>
		/// <param name="m3PRTF">Printer file (Required)</param>
		/// <param name="m3RPBK">XML section (Required)</param>
		...
		/// <returns>M3Response<M3Record></returns>
		/// <exception cref="M3Exception<M3Record>"></exception>
		public async Task<M3Response<M3Record>> UpdSectionTable(
			string m3PRTF, 
			int m3RPBK, 
			string m3FILE, 
			string m3FIPX = null, 
