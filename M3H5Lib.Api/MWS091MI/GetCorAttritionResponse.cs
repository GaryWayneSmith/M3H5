...
namespace M3H5Lib.Api.MWS091MI
{
	public partial class GetCorAttritionResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Attrition date")]
		public DateTime? M3_AODT => GetNullableDateTime("AODT");

		/// <summary>
		/// Description: Attrition quantity
		/// FieldName: ATQT
		/// FieldType: N
		/// Length: 17
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Attrition quantity")]
		public decimal? M3_ATQT => GetNullableDecimal("ATQT");
