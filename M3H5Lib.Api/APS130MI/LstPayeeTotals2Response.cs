...
{
	public partial class LstPayeeTotals2Response : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Bank country")]
		public string M3BCCD => GetString("BCCD");
		...
		[JsonIgnore]
		[Description("Bank account number for foreign payment")]
		public string M3BKAC => GetString("BKAC");
		...
		/// <summary>
		/// Description: Our customer number at supplier
		/// FieldName: OUCN
		/// FieldType: A
		/// Length: 10
		/// Nullabe: Y
