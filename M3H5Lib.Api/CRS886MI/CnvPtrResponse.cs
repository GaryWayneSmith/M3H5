...
{
	public partial class CnvPtrResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Partner alias sublevel 1
		/// FieldName: PAA1
		/// FieldType: A
		/// Length: 25
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Partner alias sublevel 2
		/// FieldName: PAA2
		/// FieldType: A
		/// Length: 25
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Partner ID highest level
		/// FieldName: PAIH
		/// FieldType: A
		/// Length: 15
		/// Nullabe: Y
