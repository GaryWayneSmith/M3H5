...
namespace M3H5Lib.Api.MMS160MI
{
	public partial class LstPutAwayLocResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Create stock take at picking
		/// FieldName: INVD
		/// FieldType: N
		/// Length: 1
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Create stock take at picking")]
		public int? M3_INVD => GetNullableInt("INVD");
