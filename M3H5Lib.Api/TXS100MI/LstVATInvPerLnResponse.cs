...
namespace M3H5Lib.Api.TXS100MI
{
	public partial class LstVATInvPerLnResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Supplier")]
		public string M3CSUN => GetString("CSUN");
		...
		[JsonIgnore]
		[Description("Supplier invoice number")]
		public string M3CSIN => GetString("CSIN");
		...
		[JsonIgnore]
		[Description("Yes/no")]
		public int? M3CMIN => GetNullableInt("CMIN");
		...
		[JsonIgnore]
		[Description("Invoice year")]
		public int? M3CINY => GetNullableInt("CINY");
		...
		[JsonIgnore]
		[Description("Invoice date")]
		public DateTime? M3CIVD => GetNullableDateTime("CIVD");
		...
		[JsonIgnore]
		[Description("Accounting date")]
		public DateTime? M3CACD => GetNullableDateTime("CACD");
