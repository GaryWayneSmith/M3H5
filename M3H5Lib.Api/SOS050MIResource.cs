...
namespace M3H5Lib.Api
{
	...
	/// <summary>
	/// Name: SOS050MI
	/// Component Name: Brands
	/// Description: Brands
	/// Version Release: 15.x
	///</summary>
	public partial class SOS050MIResource : M3BaseResourceEndpoint
	{
		public SOS050MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "SOS050MI";
		...
		/// Version Release: 15.x
		/// </summary>
		/// <param name="m3BRAN">Brand (Required)</param>
			...
			CancellationToken cancellationToken = default)
		{
			...
			if (string.IsNullOrWhiteSpace(m3BRAN))
				throw new ArgumentNullException(nameof(m3BRAN));

			// Set mandatory parameters
			request
				.WithQueryParameter("BRAN", m3BRAN.Trim());
