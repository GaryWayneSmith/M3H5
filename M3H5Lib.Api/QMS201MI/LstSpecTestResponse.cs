...
{
	public partial class LstSpecTestResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Include test in QI request")]
		public int? M3ITQR => GetNullableInt("ITQR");
		...
		[JsonIgnore]
		[Description("Print test on specification document")]
		public int? M3PTSP => GetNullableInt("PTSP");
		...
		[JsonIgnore]
		[Description("Sample usage")]
		public int? M3DUSM => GetNullableInt("DUSM");
		...
		[JsonIgnore]
		[Description("Set")]
		public string M3QSET => GetString("QSET");
