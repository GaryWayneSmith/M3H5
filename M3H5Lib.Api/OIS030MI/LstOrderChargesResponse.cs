...
namespace M3H5Lib.Api.OIS030MI
{
	public partial class LstOrderChargesResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("From external system")]
		public int? M3_FEXS => GetNullableInt("FEXS");

		/// <summary>
		/// Description: Preliminary charge
		/// FieldName: PRCE
		/// FieldType: N
		/// Length: 1
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Preliminary charge")]
		public int? M3_PRCE => GetNullableInt("PRCE");
	}
}
// EOF
