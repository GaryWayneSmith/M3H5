...
{
	public partial class GetRentalLine2Response : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Termination number
		/// FieldName: TMNR
		/// FieldType: N
		/// Length: 10
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Termination number")]
		public long? M3_TMNR => GetNullableLong("TMNR");
		...
		[JsonIgnore]
		[Description("Job type")]
		public string M3_JBTP => GetString("JBTP");
	}
}
// EOF
