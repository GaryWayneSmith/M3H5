...
{
	public partial class LstDelHeadByInvResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Ref field payment terms description
		/// FieldName: TEP1
		/// FieldType: A
		/// Length: 36
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Ref field payment terms description")]
		public string M3_TEP1 => GetString("TEP1");
		...
		/// <summary>
		/// Description: Ref field delivery terms description
		/// FieldName: TED1
		/// FieldType: A
		/// Length: 36
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Ref field delivery terms description")]
		public string M3_TED1 => GetString("TED1");
