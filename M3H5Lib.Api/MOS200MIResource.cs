...
namespace M3H5Lib.Api
{
	...
	///</summary>
	public partial class MOS200MIResource : M3BaseResourceEndpoint
	{
		public MOS200MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "MOS200MI";
		...
		/// <summary>
		/// Name CfrmAffSerialNo
		/// Description Confirm Affected Serial Number
		/// Version Release: 5ea1
		/// </summary>
		/// <param name="m3_AECN">Engineering order number (Required)</param>
		/// <param name="m3_ITNO">Item number (Required)</param>
		...
		/// <returns>M3Response<M3Record></returns>
		/// <exception cref="M3Exception<M3Record>"></exception>
		public async Task<M3Response<M3Record>> CfrmAffSerialNo(
			string m3_AECN, 
			string m3_ITNO, 
			string m3_BANO, 
			int? maxRecords = null, 
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/CfrmAffSerialNo",
			};
		...
		/// <summary>
		/// Name LstAffByEoNo
		/// Description Affected Serial Number By EO Number
		...
		/// <param name="outputColumns">List of columns to return, null or empty for all columns</param>
		/// <param name="cancellationToken"></param>
		/// <returns>M3Response<LstAffByEoNoResponse></returns>
		/// <exception cref="M3Exception<LstAffByEoNoResponse>"></exception>
		public async Task<M3Response<LstAffByEoNoResponse>> LstAffByEoNo(
			string m3_ITNO, 
			string m3_BANO = null, 
			int? maxRecords = null, 
			bool? includeMetadata = null, 
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/LstAffByEoNo",
			};
			...
			// Execute the request
			var result = await Execute<LstAffByEoNoResponse>(
				request: request,
				maxRecords: maxRecords,
				includeMetadata: includeMetadata,
				trimResults: trimResults,
		...
		/// <summary>
		/// Name LstAffByItem
		/// Description List Affected Serial Number By Item
		/// Version Release: 15.1
		/// </summary>
		/// <param name="m3_AECN">Engineering order number (Required)</param>
		/// <param name="maxRecords">Maximum number of records to return</param>
		...
		/// <param name="outputColumns">List of columns to return, null or empty for all columns</param>
		/// <param name="cancellationToken"></param>
		/// <returns>M3Response<LstAffByItemResponse></returns>
		/// <exception cref="M3Exception<LstAffByItemResponse>"></exception>
		public async Task<M3Response<LstAffByItemResponse>> LstAffByItem(
			string m3_AECN, 
			int? maxRecords = null, 
			bool? includeMetadata = null, 
			bool? trimResults = null, 
			...
			CancellationToken cancellationToken = default)
		{
			...
			M3Request request = new M3Request(M3Config)
			{
				EndpointUri = $"{M3Config.BasePath}/{ProgramName}/LstAffByItem",
			};
			...
			// Execute the request
			var result = await Execute<LstAffByItemResponse>(
				request: request,
				maxRecords: maxRecords,
				includeMetadata: includeMetadata,
				trimResults: trimResults,
		...
		/// <summary>
		/// Name LstEOLines
		/// Description List of Engineering Order Line
		/// Version Release: 5ea1
		/// </summary>
		/// <param name="m3_AECN">Engineering order number (Required)</param>
		/// <param name="maxRecords">Maximum number of records to return</param>
		...
		/// <summary>
		/// Name LstModRefComp
		/// Description List of Modification reference component
		/// Version Release: 5ea1
		/// </summary>
		/// <param name="m3_AECN">Engineering order number (Required)</param>
		/// <param name="maxRecords">Maximum number of records to return</param>
		...
		/// <summary>
		/// Name UpdModRefComp
		/// Description UpdModRefComp
		/// Version Release: 5ea0
		/// </summary>
		/// <param name="m3_AECN">Engineering order number (Required)</param>
		/// <param name="m3_AOPN">Old item number</param>
		/// <param name="m3_MODM">Modification marking</param>
		/// <param name="m3_ANPN">New item number</param>
		/// <param name="m3_AINS">Instruction</param>
		/// <param name="m3_CNQT">Quantity</param>
			...
			CancellationToken cancellationToken = default)
		{
			...
			// Set optional parameters, checking for null/blank data for each element
			if (!string.IsNullOrWhiteSpace(m3_AOPN))
				request.WithQueryParameter("AOPN", m3_AOPN.Trim());
			if (!string.IsNullOrWhiteSpace(m3_MODM))
				request.WithQueryParameter("MODM", m3_MODM.Trim());
			if (!string.IsNullOrWhiteSpace(m3_ANPN))
				request.WithQueryParameter("ANPN", m3_ANPN.Trim());
