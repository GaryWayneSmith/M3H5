...
namespace M3H5Lib.Api
{
	...
	/// Description: Orderless reporting MO interface
	/// Version Release: 5e90
	///</summary>
	public partial class PMS260MIResource : M3BaseResourceEndpoint
	{
		public PMS260MIResource(ApiClient apiClient)
			: base(apiClient)
		{
			ProgramName = "PMS260MI";
