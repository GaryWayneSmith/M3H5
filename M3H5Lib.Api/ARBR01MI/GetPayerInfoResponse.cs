...
{
	public partial class GetPayerInfoResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Numeric field 3 positions
		/// FieldName: NUM3
		/// FieldType: N
		/// Length: 3
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Numeric field 4 positions
		/// FieldName: NUM4
		/// FieldType: N
		/// Length: 4
		/// Nullabe: Y
		...
		/// <summary>
		/// Description: Numeric field 5 positions
		/// FieldName: NUM5
		/// FieldType: N
		/// Length: 5
		/// Nullabe: Y
