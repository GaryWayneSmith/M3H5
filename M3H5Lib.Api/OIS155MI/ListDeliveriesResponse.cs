...
namespace M3H5Lib.Api.OIS155MI
{
	public partial class ListDeliveriesResponse : M3BaseRecord 
	{
		...
		[JsonIgnore]
		[Description("Block code payer")]
		public int? M3_BLCP => GetNullableInt("BLCP");
