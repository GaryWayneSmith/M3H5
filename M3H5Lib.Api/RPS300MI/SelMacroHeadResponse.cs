...
{
	public partial class SelMacroHeadResponse : M3BaseRecord 
	{
		...
		/// <summary>
		/// Description: Firm Planned Proposals
		/// FieldName: FPPR
		/// FieldType: N
		/// Length: 1
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Firm Planned Proposals")]
		public int? M3_FPPR => GetNullableInt("FPPR");
		...
		/// <summary>
		/// Description: Plannning strategy
		/// FieldName: PSTR
		/// FieldType: N
		/// Length: 1
		/// Nullabe: Y
		...
		[JsonIgnore]
		[Description("Plannning strategy")]
		public int? M3_PSTR => GetNullableInt("PSTR");
